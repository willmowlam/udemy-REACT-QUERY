...
export function useAppointments() {
  ...
  // prefetch next month when monthYear changes so the cache is populated with next month's data before user clicks next
  ...
  }, [queryClient, monthYear]); // Dependency array of mon
